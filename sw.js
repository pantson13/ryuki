// Ryuki v115: atomic core update. A build is either complete or it never activates.
const BUILD = "115";
const CACHE_PREFIX = "ryuki-pwa-";
const CACHE_NAME = "ryuki-pwa-v115-stable";
...
self.addEventListener("fetch", (event) => {
  ...
  // 这样同一次 v115 绝不会一会播放安装时的 charu、一会又被网络上的另一份覆盖。
