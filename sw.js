// Ryuki v102: card-box drag mocha audio
const BUILD = "102";
const CACHE_NAME = "ryuki-pwa-v102-cardbox-mocha-drag";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./assets/audio/kh1.mp3?av=102",
  "./assets/audio/ydmusic.mp3?av=102",
  "./assets/audio/charu.mp3?av=102",
  "./assets/audio/mocha.mp3?av=102",
  "./assets/audio/chouka.mp3?av=102",
  "./assets/audio/chaka.mp3?av=102",
  "./assets/audio/huagai1.mp3?av=102",
  "./assets/audio/huagai2.mp3?av=102",
  "./assets/audio/j.mp3?av=102",
  "./assets/audio/q.mp3?av=102",
  "./assets/audio/d.mp3?av=102",
  "./assets/audio/l.mp3?av=102",
  "./assets/audio/f.mp3?av=102",
  "./assets/audio/hc.mp3?av=102",
  "./assets/audio/jianjianglin.mp3?av=102",
  "./assets/audio/longjiao.mp3?av=102",
  "./assets/audio/bsj.mp3?av=102",
  "./assets/audio/guo.mp3?av=102",
...
self.addEventListener("fetch", (event) => {
  ...
  // v102：音频使用 Network First。配合 ?av=102 资源版本，覆盖同名 mp3 后不会再随机命中旧媒体缓存。
